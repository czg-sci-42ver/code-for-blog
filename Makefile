# https://gcc.gnu.org/onlinedocs/gcc-3.4.6/gnat_ugn_unw/Automatically-Creating-a-List-of-Directories.html from https://stackoverflow.com/a/13898309/21294350
ROOT_DIRECTORY=.
SUBDIRS := ${sort ${dir $(wildcard ${ROOT_DIRECTORY}/*/*/)}}
all: $(SUBDIRS)
# clean: $(SUBDIRS)
